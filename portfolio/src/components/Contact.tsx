  ...
  return (
    <div className="contactPage">
      ...
      <p className="contactDescription">
        Feel free to reach me at any of the links below...
      </p>
      <div className="chipContainer">
        <IonChip className="chip" outline color="secondary">
          ...
          <IonLabel className="contactLabel">Linkedin</IonLabel>
        </IonChip>
        <IonChip className="chip" outline color="secondary">
          <i
          ...
          <IonLabel className="contactLabel">Email</IonLabel>
        </IonChip>
        <IonChip className="chip" outline color="secondary">
          <svg viewBox="0 0 128 128" className="githubIcon">
            <g fill="#FFFFFF">
          ...
          <IonLabel className="contactLabel">GitHub</IonLabel>
        </IonChip>
      </div>
    </div>
  );
